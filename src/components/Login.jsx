...
const Login = () => {
    return (
        <div className='bg-gray-300 h-screen w-screen relative overflow-hidden flex flex-col justify-center items-center'>
            <div className='w-40-r h-40-r bg-gradient-to-r from-cyan-500 to-blue-600 rounded-3xl rotate-45 absolute left-2/3 md:-top-96 -top-72'></div>
            <div className='w-35-r h-35-r bg-gradient-to-r from-[#A91079] to-[#570A57] rounded-3xl rotate-45 absolute top-3/4 md:top-2/3 -left-72 md:-left-9'></div>
            <div className='container h-96 md:w-35-r w-80 bg-gray-900 bg-opacity-70 relative z-2 rounded-2xl shadow-2xl border border-r-0 border-b-0 border-l-gray-500 border-t-gray-500
            '>
